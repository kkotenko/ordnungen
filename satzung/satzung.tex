...
\Clause{title={Zuständigkeit des Vorstands}}
	...
	\end{subpara}
\Clause{title={Wahl des Vorstands}}
...
\Clause{title={Arbeitsweise des Vorstands}}
...
\Clause{title={Auflösung des Vereins, vertretungsberechtigte Liquidatoren}}
